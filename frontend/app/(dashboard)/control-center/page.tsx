...
import {
  ...
  ShoppingBag, Wand2, ShoppingCart, Store,
} from "lucide-react"
              ...
              <Card className="h-full hover:bg-accent/20 transition-colors">
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className={`w-10 h-10 rounded-lg ${system.bg} flex items-center justify-center shrink-0`}>
                      <system.icon className={`w-5 h-5 ${system.accent}`} />
                    </div>
                    <div className="min-w-0">
                      <p className="text-sm font-semibold text-foreground">{system.name}</p>
                      <p className="text-xs text-muted-foreground mt-1 leading-relaxed">{system.desc}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
